...
Prepare venus according to [README](../../README.md)
Add variables required for `@venusos/plugin-cosmos` :
...
Ensure the appropriate environment variables are added for the plugin. If they are correctly configured, the project will run with `@venusos/plugin-cosmos`
