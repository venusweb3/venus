...
const mintNFTAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            venusLogger.log("Generate Object:", content);

            if (!isMintNFTContent(content)) {
                venusLogger.error("Invalid content for MINT_NFT action.");
                if (callback) {
                    callback({
            ...
            if (content?.chainName === "solana") {
                ...
                venusLogger.log("Collection Info", collectionInfo);
                ...
                if (metadata) {
                    ...
                    venusLogger.log("NFT Address:", nftRes);
