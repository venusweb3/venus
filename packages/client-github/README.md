# Client-GitHub for venus Framework

## Overview

The `client-github` module is a component of the venus framework designed to interact with GitHub repositories. It provides functionalities to clone repositories, manage branches, create pull requests, and maintain file-based knowledge for venus agents.
...
Install the package as part of the venus framework:
bash
pnpm add @venusos/client-github
...
import { GitHubClientInterface } from "@venusos/client-github";
