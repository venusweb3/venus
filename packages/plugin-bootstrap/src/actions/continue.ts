...
import { generateMessageResponse, generateTrueOrFalse } from "@venusos/core";
import { booleanFooter, messageCompletionFooter } from "@venusos/core";
import {
    Action,
    ActionExample,
    Content,
...
export const continueAction: Action = {
    ...
    handler: async (
        ...
        if (!shouldContinue) {
            venusLogger.log("[CONTINUE] Not elaborating, returning");
            return;
        }
