# @venusos/plugin-bootstrap

A plugin providing core functionality and basic actions for venusOS agents.
...
```bash
pnpm install @venusos/plugin-bootstrap
```
...
- The venus Core development team
