...
export default {
    ...
    handler: async (
        ...
        venusLogger.log("Starting ESCROW_OPERATION handler...");
        ...
        if (!isEscrowContent(content)) {
            venusLogger.error("Invalid content for ESCROW_OPERATION action.");
            callback?.({
        ...
        try {
            ...
            venusLogger.log(`Current ${content.token} balance:`, balance);
            ...
            if (content.operation === "check") {
                ...
                try {
                    ...
                    venusLogger.error("Deposit operation failed:", error);
                    callback?.({
                ...
                try {
                    ...
                    venusLogger.error("Withdraw operation failed:", error);
                    callback?.({
            ...
            venusLogger.error("Escrow operation failed:", error);
            callback?.({
