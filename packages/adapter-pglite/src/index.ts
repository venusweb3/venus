        ...
        return this.withTransaction(async (tx) => {
            try {
                ...
                if (checkResult.rows.length === 0) {
                    venusLogger.warn("No room found to remove:", {
                        roomId,
                    });
    ...
    async getKnowledge(params: {
        ...
        return this.withDatabase(async () => {
            try {
                ...
                venusLogger.error("Error getting knowledge", {
                    error:
                        error instanceof Error ? error.message : String(error),
                    id: params.id,
                    agentId: params.agentId,
    ...
    async searchKnowledge(params: {
        ...
        return this.withDatabase(async () => {
            ...
            `;
                ...
                venusLogger.error("Error searching knowledge", {
                    error:
                        error instanceof Error ? error.message : String(error),
    ...
    async createKnowledge(knowledge: RAGKnowledgeItem): Promise<void> {
        return this.withTransaction(async (tx) => {
            try {
                ...
                venusLogger.error("Failed to create knowledge:", {
                    error:
                        error instanceof Error ? error.message : String(error),
                });
                throw error;
    ...
    async clearKnowledge(agentId: UUID, shared?: boolean): Promise<void> {
        return await this.withTransaction(async (tx) => {
            try {
                ...
                tx.rollback();
                venusLogger.error("Error clearing knowledge", {
                    error:
                        error instanceof Error ? error.message : String(error),
                    agentId,
                });
