...
class RemoteAttestationProvider {
    ...
    async generateAttestation(
        ...
        try {
            venusLogger.log("Generating attestation for: ", reportData);
            ...
            venusLogger.log("Remote attestation quote: ", quote);
            return quote;
        } catch (error) {
...
const remoteAttestationProvider: Provider = {
    get: async (runtime: IAgentRuntime, message: Memory, _state?: State) => {
        ...
        try {
            ...
            venusLogger.log("Generating attestation for: ", JSON.stringify(attestationMessage));
