...
export const getGPUPricingAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, message: Memory): Promise<boolean> => {
        venusLogger.debug("Validating GPU pricing request", { message });
        try {
            ...
            venusLogger.error("GPU pricing validation failed", {
    ...
    handler: async (
        ...
        venusLogger.info("Starting GPU pricing request", { actionId });
        ...
        try {
            ...
            venusLogger.info("Fetching pricing information", {
                specs: requestBody,
            ...
            venusLogger.info("Pricing information retrieved successfully", {
                specs: data.spec,
                pricing: {
                    akash: data.akash,
                    aws: data.aws,
            ...
            venusLogger.error("GPU pricing request failed", {
