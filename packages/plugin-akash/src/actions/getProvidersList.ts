...
export const getProvidersListAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, message: Memory): Promise<boolean> => {
        venusLogger.debug("Validating get providers list request", { message });
        try {
            ...
            venusLogger.error("Get providers list validation failed", {
    ...
    handler: async (
        ...
        venusLogger.info("Starting providers list request", { actionId });

        try {
            await validateAkashConfig(runtime);
            const params = message.content as GetProvidersListContent;

            venusLogger.info("Fetching providers list", {
            ...
            venusLogger.info("Providers list retrieved successfully", {
            ...
            venusLogger.error("Get providers list request failed", {
                error: error instanceof Error ? error.message : String(error),
