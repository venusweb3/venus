...
import { settings, venusLogger } from "@venusos/core";
...
export const executeSwap = async (
    ...
    try {
        ...
        if (confirmation.value.err) {
            venusLogger.log("Confirmation error", confirmation.value.err);
...
export const Sell = async (baseMint: PublicKey, wallet: Keypair) => {
    try {
        ...
        if (!tokenBalInfo) {
            venusLogger.log("Balance incorrect");
            return null;
        }
        ...
        if (!sellTransaction) {
            venusLogger.log("Failed to get sell transaction");
            return null;
        }
        ...
        if (simulateResult.value.err) {
            venusLogger.log("Sell Simulation failed", simulateResult.value.err);
            return null;
        }
...
export const Buy = async (baseMint: PublicKey, wallet: Keypair) => {
    try {
        ...
        // simulate the transaction
        if (!buyTransaction) {
            venusLogger.log("Failed to get buy transaction");
            return null;
        }
        ...
        if (simulateResult.value.err) {
            venusLogger.log("Buy Simulation failed", simulateResult.value.err);
            return null;
        }
...
export const fetchBuyTransaction = async (
    ...
    try {
        ...
        venusLogger.log("Failed to get buy transaction", error);
        return null;
    }
};
...
export const fetchSellTransaction = async (
    ...
    try {
        ...
        venusLogger.log("Failed to get sell transaction", error);
        return null;
    }
};
