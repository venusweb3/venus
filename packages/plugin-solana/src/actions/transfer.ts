...
export default {
    ...
    validate: async (runtime: IAgentRuntime, message: Memory) => {
        venusLogger.log("Validating transfer from user:", message.userId);
        //add custom validate logic here
        /*
            const adminIds = runtime.getSetting("ADMIN_USER_IDS")?.split(",") || [];
            //venusLogger.log("Admin IDs from settings:", adminIds);

            const isAdmin = adminIds.includes(message.userId);

            if (isAdmin) {
                //venusLogger.log(`Authorized transfer from user: ${message.userId}`);
                return true;
            }
            else
            {
                //venusLogger.log(`Unauthorized transfer attempt from user: ${message.userId}`);
                return false;
            }
            */
        return false;
    ...
    handler: async (
        ...
        venusLogger.log("Starting SEND_TOKEN handler...");
        ...
        try {
            ...
            venusLogger.log("Transfer successful:", signature);
