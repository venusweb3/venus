# @venusos/plugin-solana

Core Solana blockchain plugin for venus OS that provides essential services and actions for token operations, trading, and DeFi integrations.

## Overview

The Solana plugin serves as a foundational component of venus OS, bridging Solana blockchain capabilities with the venus ecosystem. It provides crucial services for token operations, trading, portfolio management, and DeFi integrations, enabling both automated and user-directed interactions with the Solana blockchain.
...
```bash
npm install @venusos/plugin-solana
```
