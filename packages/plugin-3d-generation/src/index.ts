...
const generate3D = async (prompt: string, runtime: IAgentRuntime) => {
    ...
    try {
        venusLogger.log("Starting 3D generation with prompt:", prompt);
        ...
        venusLogger.error("3D generation error:", error);
        return {
            success: false,
...
const ThreeDGeneration: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        venusLogger.log("Validating 3D generation action");
    ...
    handler: async (
        ...
        venusLogger.log("3D generation request:", message);
        ...
        venusLogger.log("3D prompt:", ThreeDPrompt);
        ...
        try {
            ...
            venusLogger.error(`Failed to generate 3D. Error: ${error}`);
            callback({
