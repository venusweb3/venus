...
export class GetAvailableLicensesAction {
    ...
    async getAvailableLicenses(
        ...
        try {
            ...
            venusLogger.log("licenseDetailsResponse", licenseDetailsResponse);
            return licenseDetailsResponse;
        } catch (e) {
            venusLogger.error("Failed to parse response");
...
export const getAvailableLicensesAction = {
    ...
    handler: async (
        ...
        venusLogger.log("Starting GET_AVAILABLE_LICENSES handler...");
        ...
        try {
            ...
            venusLogger.error("Error fetching available licenses:", e.message);
            callback?.({
