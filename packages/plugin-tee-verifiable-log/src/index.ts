import { IAgentRuntime, type Plugin, Service, ServiceType } from "@venusos/core";
...
export const verifiableLogPlugin: Plugin = {
    ...
    description:
        "While venus operates within the TEE, it uses a derived key pair to sign its actions, ensuring that these actions are definitively executed by venus. Third-party users can remotely verify venus's public key to validate these actions",
    actions: [],
    evaluators: [],
    providers: [],
