...
export const getTransactionAction: Action = {
    ...
    handler: async (
        ...
        venusLogger.info("Starting get transaction action");
        ...
        venusLogger.success("Successfully retrieved transaction details");
        venusLogger.debug("Transaction details:", result);
        await callback(
            {
