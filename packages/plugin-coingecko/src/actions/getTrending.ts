...
export default {
    ...
    handler: async (
        ...
        venusLogger.log("Starting CoinGecko GET_TRENDING handler...");
        ...
        try {
            ...
            venusLogger.log("Composing trending context...");
            ...
            if (!isGetTrendingContent(result.object)) {
                venusLogger.error("Invalid trending request format");
                return false;
            }
            ...
            venusLogger.log("Fetching trending data...");
            ...
            venusLogger.success("Trending data retrieved successfully!");
            ...
            venusLogger.error("Error in GET_TRENDING handler:", error);
