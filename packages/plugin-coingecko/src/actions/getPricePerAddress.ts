...
export default {
    ...
    handler: async (
        ...
        venusLogger.log("Starting GET_TOKEN_PRICE_BY_ADDRESS handler...");
        ...
        try {
            venusLogger.log("Composing token price context...");
            ...
            if (!isGetTokenPriceContent(result.object)) {
                venusLogger.error("Invalid token price request format");
                return false;
            }
            ...
            // Fetch token data
            venusLogger.log("Fetching token data...");
            ...
            venusLogger.success("Token price data retrieved successfully!");
