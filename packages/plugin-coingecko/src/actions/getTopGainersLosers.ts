...
export default {
    ...
    handler: async (
        ...
        venusLogger.log("Starting CoinGecko GET_TOP_GAINERS_LOSERS handler...");
        ...
        try {
            venusLogger.log("Composing gainers/losers context...");
            ...
            if (!isGetTopGainersLosersContent(result.object)) {
                venusLogger.error("Invalid gainers/losers request format");
                return false;
            }
            ...
            venusLogger.log("Fetching top gainers/losers data...");
            ...
            venusLogger.error("Error in GET_TOP_GAINERS_LOSERS handler:", error);
