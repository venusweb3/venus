...
export const xChainSwapAction = {
    ...
    handler: async (
        ...
        venusLogger.log("Starting X_CHAIN_SWAP handler...");
        ...
        venusLogger.log("swap content: ",JSON.stringify(content));
        ...
        try {
            ...
            venusLogger.log(`Finished! Check Axelarscan for details: ${axelarScanLink}`);
            ...
            venusLogger.error("Error during cross-chain swap:", error);
            if (callback) {
                callback({
