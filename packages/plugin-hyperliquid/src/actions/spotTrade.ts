...
export const spotTrade: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            venusLogger.info("Validated order:", validatedOrder);
            ...
            venusLogger.info("Found token:", tokenInfo.name);
            ...
            venusLogger.info("Placing order:", orderRequest);
            ...
            venusLogger.error("Error placing spot order:", error);
            if (callback) {
                callback({
