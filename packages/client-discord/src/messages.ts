import { composeContext, composeRandomUser } from "@venusos/core";
...
import { stringToUuid, getEmbeddingZeroVector } from "@venusos/core";
import {
    ChannelType,
    Client,
...
export class MessageManager {
    ...
    private async _shouldIgnore(message: DiscordMessage): Promise<boolean> {
        ...
        // short responses where venus should stop talking and disengage unless mentioned again
        if (
    ...
    private async _shouldRespond(
        ...
        try {
            ...
            venusLogger.error("Error in _shouldRespond team processing:", {
                error,
                agentId: this.runtime.agentId,
