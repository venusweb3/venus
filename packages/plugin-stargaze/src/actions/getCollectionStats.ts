...
export default {
    ...
    validate: async (runtime: IAgentRuntime, message: Memory) => {
        venusLogger.log("🔄 Validating Stargaze configuration...");
        try {
    ...
    handler: async (
        ...
        venusLogger.log("🚀 Starting Stargaze GET_COLLECTION_STATS handler...");
        ...
        try {
            venusLogger.log("Composing collection stats context...");
...
- Market Cap: ${formatValue(stats.marketCap)} USD`,
                ...
                venusLogger.log("✅ Sending callback with collection stats:", message);
                callback(message);
            }
