...
import { ModelClass, IAgentRuntime, Memory, State, generateObject } from '@venusos/core';
import { TweetContent, TweetSchema } from '../src/types';
import { tweetTemplate } from '../src/templates';
import { UUID } from '../../core/src/types';

// Mock @venusos/core
vi.mock('@venusos/core', async () => {
    const actual = await vi.importActual('@venusos/core');
    return {
        ...actual,
