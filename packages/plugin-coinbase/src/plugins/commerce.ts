...
export async function createCharge(apiKey: string, params: ChargeRequest) {
    venusLogger.debug("Starting createCharge function");
    try {
        ...
        venusLogger.error("Error creating charge:", error);
        throw error;
    }
}
...
export async function getAllCharges(apiKey: string) {
    venusLogger.debug("Starting getAllCharges function");
    try {
        const response = await fetch(url, {
            method: "GET",
            headers: {
        ...
        venusLogger.error("Error fetching charges:", error);
        throw error;
    }
}
...
export async function getChargeDetails(apiKey: string, chargeId: string) {
    venusLogger.debug("Starting getChargeDetails function");
...
export const createCoinbaseChargeAction: Action = {
    ...
    handler: async (
        ...
        venusLogger.info("Composing state for message:", message);
        if (!state) {
        ...
        venusLogger.info("Charge details received:", chargeDetails);

        // Initialize Coinbase Commerce client
        venusLogger.debug("Starting Coinbase Commerce client initialization");
        try {
            // Create a charge
...
export const getAllChargesAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            venusLogger.info("Fetched all charges:", charges);
            ...
            venusLogger.error("Error fetching all charges:", error);
            callback(
                {
...
export const getChargeDetailsAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            venusLogger.info("Fetched charge details:", chargeDetails);
...
export const chargeProvider: Provider = {
    get: async (runtime: IAgentRuntime, _message: Memory) => {
        venusLogger.debug("Starting chargeProvider.get function");
        const charges = await getAllCharges(
            runtime.getSetting("COINBASE_COMMERCE_KEY")
        );
        ...
        venusLogger.info("Charges:", formattedCharges);
