...
export const deployTokenContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        venusLogger.info("Validating runtime for DEPLOY_TOKEN_CONTRACT...");
        return (
            !!(
    ...
    handler: async (
        ...
        venusLogger.debug("Starting DEPLOY_TOKEN_CONTRACT handler...");
        ...
        try {
            ...
            venusLogger.info("Contract details:", contractDetails.object);
            ...
            await contract.wait();
            venusLogger.info("Deployment details:", deploymentDetails);
            venusLogger.info("Contract deployed successfully:", contract);
...
Contract deployment has been logged to the CSV file.`,
            ...
            venusLogger.error("Error deploying token contract:", error);
            callback(
                {
...
export const invokeContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        venusLogger.info("Validating runtime for INVOKE_CONTRACT...");
        return (
            !!(
                runtime.character.settings.secrets?.COINBASE_API_KEY ||
                process.env.COINBASE_API_KEY
    ...
    handler: async (
        ...
        venusLogger.debug("Starting INVOKE_CONTRACT handler...");
        ...
        try {
            ...
            venusLogger.info("Invocation details:", invocationDetails.object);
            ...
            venusLogger.info("Invocation options:", invocationOptions);
            // Invoke the contract
...
Contract invocation has been logged to the CSV file.`,
            ...
            venusLogger.error("Error invoking contract method:", error);
            callback(
                {
...
export const readContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        venusLogger.info("Validating runtime for READ_CONTRACT...");
        return (
            !!(
                runtime.character.settings.secrets?.COINBASE_API_KEY ||
                process.env.COINBASE_API_KEY
    ...
    handler: async (
        ...
        venusLogger.debug("Starting READ_CONTRACT handler...");
        ...
        try {
            ...
            const { contractAddress, method, args, networkId, abi } =
                readDetails.object;
            venusLogger.info("Reading contract:", {
                contractAddress,
                method,
                args,
                networkId,
            ...
            venusLogger.info("Contract read result:", serializedResult);
...
- Result: ${JSON.stringify(serializedResult, null, 2)}`,
            ...
            venusLogger.error("Error reading contract:", error);
            callback(
                {
