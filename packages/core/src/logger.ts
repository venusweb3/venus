class venusLogger {
    constructor() {
        ...
        console.log(`[venusLogger] Initializing with:
            isNode: ${this.isNode}
    ...
    debug(...strings) {
        if (!this.verbose) {
            ...
            // console.log(
            //     "[venusLogger] Debug message suppressed (verbose=false):",
            //     ...strings
            // );
            return;
        }
...
export const venusLogger = new venusLogger();
venusLogger.closeByNewLine = true;
venusLogger.useIcons = true;

export default venusLogger;
