...
venusLogger.info("Loading embedding settings:", {
...
venusLogger.info("Loading character settings:", {
...
export function loadEnvConfig(): Settings {
    ...
    if (!result.error) {
        venusLogger.log(`Loaded .env file from: ${envPath}`);
    }
...
venusLogger.info("Parsed settings:", {
