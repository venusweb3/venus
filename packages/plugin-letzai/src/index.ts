import { venusLogger, HandlerCallback, IAgentRuntime, Plugin, State } from "@venusos/core";
import { Memory } from "@venusos/core";
...
export const letzAiImageGeneration = {
    ...
    handler: async (
        ...
        try {
            ...
            venusLogger.log("Composing state for message:", message.content.text);
