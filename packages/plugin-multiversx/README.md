# @venusos/plugin-multiversx

MultiversX blockchain integration plugin for venus OS that enables token management and transfers.
...
```bash
pnpm install @venusos/plugin-multiversx
```
