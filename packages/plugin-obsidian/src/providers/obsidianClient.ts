...
export class ObsidianProvider {
    ...
    async connect(): Promise<void> {
        ...
        try {
            ...
            venusLogger.error("Failed to connect to Obsidian:", error.message);
    ...
    async listNotes(): Promise<string[]> {
        ...
        try {
            ...
            venusLogger.error("Failed to list notes:", error.message);
            throw error;
        }
    }
    ...
    async getNote(path: string): Promise<NoteContent> {
        ...
        try {
            ...
            venusLogger.error("Failed to fetch note content:", error);
            throw error;
        }
    }
    ...
    async getActiveNote(): Promise<NoteContent> {
        ...
        try {
            ...
            venusLogger.error("Failed to fetch active note content:", error.message);
            throw error;
        }
    }
    ...
    async saveNote(
        ...
        try {
            ...
            venusLogger.error("Failed to save note:", error.message);
            throw error;
        }
    }
    ...
    async listFiles(): Promise<string[]> {
        ...
        try {
            ...
            venusLogger.error("Failed to list files:", error.message);
            throw error;
        }
    }
    ...
    async listDirectoryFiles(directoryPath: string): Promise<string[]> {
        ...
        try {
            ...
            venusLogger.error("Failed to list directory contents:", error.message);
            throw error;
        }
    }
    ...
    async readFile(path: string): Promise<string> {
        ...
        try {
            ...
            venusLogger.error("Failed to read file content:", error.message);
            throw error;
        }
    }
    ...
    async openFile(filePath: string): Promise<void> {
        ...
        try {
            ...
            venusLogger.success(`Successfully opened file: ${filePath}`);
        } catch (error) {
            venusLogger.error(`Failed to open file '${filePath}':`, error.message);
            throw error;
        }
    }
    ...
    async saveFile(
        ...
        try {
            ...
            venusLogger.error("Failed to save file:", error.message);
            throw error;
        }
    }
    ...
    async patchFile(
        ...
        try {
            ...
            venusLogger.error("Failed to patch file content:", error.message);
            throw error;
        }
    }
    ...
    async listCommands(): Promise<{ id: string; name: string }[]> {
        ...
        try {
            ...
            venusLogger.error("Failed to list commands:", error.message);
            throw error;
        }
    }
    ...
    async executeCommand(commandId: string): Promise<void> {
        ...
        try {
            ...
            venusLogger.error("Failed to execute command:", error.message);
            throw error;
        }
    }
    ...
    async search(
        ...
        try {
            ...
            venusLogger.error('Search failed:', error.message);
            throw error;
        }
    }
    ...
    async searchKeywords(
        ...
        try {
            ...
            venusLogger.success(`Found ${uniqueResults.length} unique results`);
            venusLogger.debug("Search results:", uniqueResults);
            return uniqueResults;
        } catch (error) {
            venusLogger.error("Obsidian search failed:", error.message);
            throw error;
        }
    }
    ...
    private async scanDirectoryRecursively(directory: string = ''): Promise<string[]> {
        ...
        while (dirsToProcess.length > 0) {
            ...
            try {
                venusLogger.debug(`Scanning directory: ${currentDir}`);
                ...
                venusLogger.error(`Error scanning directory ${currentDir}:`, error);
            }
        }
    ...
    async getAllFiles(): Promise<string[]> {
        ...
        try {
            venusLogger.debug("Starting file scanning process");
            ...
            venusLogger.info(`Completed scanning. Found ${allFiles.length} files in vault`);
            ...
            venusLogger.error("Error in getAllFiles:", error);
            throw error;
        }
    }
    ...
    async createMemoriesFromFiles(): Promise<number> {
        try {
            venusLogger.info("Starting to create memories from vault files");
            const allFiles = await this.getAllFiles();

            venusLogger.debug("All files:", allFiles);
            venusLogger.success(`Found ${allFiles.length} files in vault`);
            //return allFiles;
            ...
            for (const file of allFiles) {
                try {
                    ...
                    if (!content) {
                        venusLogger.warn(`No content found for file: ${file}`);
                        continue;
                    }
                    ...
                    if (
                        ...
                        venusLogger.debug(`Skipping unchanged file: ${file}`);
                        continue;
                    }
                    ...
                    venusLogger.error(`Error processing file ${file}:`, error);
                    continue;
                }
            }

            venusLogger.success("Finished creating memories from vault notes");

            return allFiles.length;

        } catch (error) {
            venusLogger.error("Error in createMemoriesFromFiles:", error);
            return 0;
        }
    }
