# @venusos/plugin-abstract

A plugin for interacting with the Abstract blockchain network within the venusOS ecosystem.
...
```bash
pnpm install @venusos/plugin-lensNetwork
```
