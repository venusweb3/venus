import { venusLogger, Client, IAgentRuntime, Plugin } from "@venusos/core";
...
export const EchoChamberClientInterface: Client = {
    async start(runtime: IAgentRuntime) {
        try {
            ...
            venusLogger.log("Starting EchoChambers client...");
            ...
            venusLogger.error("Failed to start EchoChambers client:", error);
            throw error;
        }
    },
    ...
    async stop(runtime: IAgentRuntime) {
        try {
            venusLogger.warn("Stopping EchoChambers client...");
            ...
            venusLogger.success("EchoChambers client stopped successfully");
        } catch (error) {
            venusLogger.error("Error stopping EchoChambers client:", error);
            throw error;
        }
    },
};
