...
A plugin for text-to-speech(TTS) generation using the FAL.ai API within the venusOS ecosystem.
...
```bash
pnpm install @venusos/plugin-tts
```
...
```typescript
import { TTSGenerationPlugin } from "@venusos/plugin-tts";
```
...
"Create a TTS for Welcome to venusOS";
...
- [venusOS](https://venusos.com): Core framework
...
- [venusOS Documentation](https://docs.venusos.com)
