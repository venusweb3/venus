...
Core Sui blockchain plugin for venus OS that provides essential services and actions for token operations and wallet management.
...
```bash
npm install @venusos/plugin-sui
```
