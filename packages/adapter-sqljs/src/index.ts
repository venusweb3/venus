    ...
    implements IDatabaseCacheAdapter
{
    ...
    async createAccount(account: Account): Promise<boolean> {
      ...
      `;
            ...
            venusLogger.error("Error creating account", error);
            return false;
        }
    }
  ...
  AND roomId = ?`;
    ...
    async createRoom(roomId?: UUID): Promise<UUID> {
        ...
        try {
            ...
            venusLogger.error("Error creating room", error);
        }
    ...
    async addParticipant(userId: UUID, roomId: UUID): Promise<boolean> {
        try {
            ...
            venusLogger.error("Error adding participant", error);
            return false;
        }
    }
    ...
    async removeParticipant(userId: UUID, roomId: UUID): Promise<boolean> {
        try {
            ...
            venusLogger.error("Error removing participant", error);
            return false;
        }
    }
    ...
    async getRelationship(params: {
        ...
        try {
            ...
            venusLogger.error("Error fetching relationship", error);
        }
        return relationship;
    }
    ...
    async deleteCache(params: {
        ...
        try {
            ...
            venusLogger.error("Error removing cache", error);
            return false;
        }
    }
