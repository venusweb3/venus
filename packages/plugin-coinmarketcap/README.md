# @venusos/plugin-coinmarketcap

A plugin for venus that enables cryptocurrency price checking using the CoinMarketCap API.
...
```bash
npm install @venusos/plugin-coinmarketcap
```
...
- [GitHub Repository](https://github.com/venusos/venus/tree/main/packages/plugin-coinmarketcap)
