import { venusLogger, IAgentRuntime } from "@venusos/core";
...
export function getWalletKeypair(runtime?: IAgentRuntime): Keypair {
    ...
    try {
        ...
        venusLogger.error("Failed to create wallet keypair:", error);
        throw error;
    }
}
...
export async function getWalletBalance(
    ...
    try {
        ...
        venusLogger.log("Fetched Solana wallet balance:", {
        ...
        venusLogger.error("Failed to get wallet balance:", error);
        return 0;
    }
}
...
export async function executeTrade(
    ...
    try {
        venusLogger.log("Executing Solana trade with params:", params);

        const SOL_ADDRESS = "So11111111111111111111111111111111111111112";

        if (!params.isSell && params.amount < SAFETY_LIMITS.MINIMUM_TRADE) {
            venusLogger.warn("Trade amount too small:", {
        ...
        venusLogger.log("Trade execution details:", {
        ...
        if (!quoteResponse.ok) {
            ...
            venusLogger.warn("Quote request failed:", {
        ...
        if (!quoteData || quoteData.error) {
            venusLogger.warn("Invalid quote data:", quoteData);
            return {
                success: false,
        ...
        venusLogger.log("Transaction sent:", signature);
        ...
        venusLogger.log("Solana trade executed successfully:", {
            signature,
        ...
        venusLogger.error("Trade execution failed:", {
