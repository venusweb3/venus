...
export default {
    ...
    handler: async (
        ...
        venusLogger.log("Starting SUBMIT_DATA handler...");
        ...
        if (content.data != null) {
            try {
                ...
                venusLogger.log(`Transaction Fee for Submit Data:
          ...
          `);
                ...
                venusLogger.error("Error during data submission:", error);
                if (callback) {
                    callback({
            ...
            venusLogger.log("No data mentioned to be submitted");
        }
    },
