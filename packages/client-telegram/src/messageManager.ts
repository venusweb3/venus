...
import { getEmbeddingZeroVector } from "@venusos/core";
import {
    Content,
    HandlerCallback,
    IAgentRuntime,
...
import { stringToUuid } from "@venusos/core";

import { generateMessageResponse, generateShouldRespond } from "@venusos/core";
import { messageCompletionFooter, shouldRespondFooter } from "@venusos/core";
...
export class MessageManager {
    ...
    private async processImage(
        ...
        try {
            ...
            venusLogger.info(`Telegram Message: ${message}`);
    ...
    private async _shouldRespond(
        ...
        if (
            ...
            venusLogger.info(`Bot mentioned`);
            return true;
        }
    ...
    private async sendImage(
        ...
        try {
            ...
            venusLogger.info(`Image sent successfully: ${imagePath}`);
        } catch (error) {
            venusLogger.error("Error sending image:", error);
        }
    }
    ...
    private async sendAnimation(
        ...
        try {
            ...
            venusLogger.info(`Animation sent successfully: ${animationPath}`);
        } catch (error) {
            venusLogger.error("Error sending animation:", error);
        }
    }
    ...
    public async handleMessage(ctx: Context): Promise<void> {
        ...
        try {
            ...
            venusLogger.error("Error sending message:", error);
        }
    }
}
