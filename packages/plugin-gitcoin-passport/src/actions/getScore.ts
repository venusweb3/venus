...
export const getPassportScoreAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        venusLogger.log("Validating runtime for GET_PASSPORT_SCORE...");
    ...
    handler: async (
        ...
        venusLogger.log("Starting GET_PASSPORT_SCORE handler...");
        const apiKey = runtime.getSetting("PASSPORT_API_KEY");
        const scorerId = runtime.getSetting("PASSPORT_SCORER");
        ...
        try {
            ...
            venusLogger.error("Error fetching Passport score:", error);
            callback(
                {
