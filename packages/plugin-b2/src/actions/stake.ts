...
export class StakeAction {
    ...
    async stake(params: StakeParams): Promise<Hash> {
        try {
            ...
            venusLogger.error(`Stake failed: ${error.message}`);
...
export const stakeAction: Action = {
    ...
    handler: async (
        ...
        venusLogger.debug("Starting STAKE handler...");
        ...
        venusLogger.debug("stake action handler called");
        ...
        venusLogger.debug("Stake paramOptions:", paramOptions);
