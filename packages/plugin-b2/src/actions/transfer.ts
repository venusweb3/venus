...
export class TransferAction {
    ...
    async transfer(params: TransferParams): Promise<Transaction> {
        try {
            ...
            venusLogger.error(`Transfer failed: ${error.message}`);
...
export const transferAction: Action = {
    ...
    handler: async (
        ...
        venusLogger.debug("Starting SEND_TOKEN handler...");
        ...
        venusLogger.debug("Transfer action handler called");
        ...
        venusLogger.debug("Transfer paramOptions:", paramOptions);
