...
export const sendToken = async (
    ...
    try {
        ...
        venusLogger.debug("Request:", request);
        const walletClient = walletProvider.getWalletClient();
        const tx = await walletClient.writeContract(request);
        venusLogger.debug("Transaction:", tx);
        return tx as Hash;
    } catch (error) {
        venusLogger.error("Error simulating contract:", error);
        return;
    }
};
...
export const approve = async (
    ...
    try {
        ...
        venusLogger.error("Error approving:", error);
        return;
    }
};
...
export const depositBTC = async (
    ...
    try {
        ...
        venusLogger.debug("Transaction hash:", txHash);
        return txHash;
    } catch (error) {
        venusLogger.error("Error depositBTC:", error);
        return;
    }
};
...
export const unstake = async (
    ...
    try {
        ...
        venusLogger.error("Error unstake:", error);
        return;
    }
};
...
export const withdraw = async (
    ...
    try {
        ...
        venusLogger.error("Error withdraw:", error);
        return;
    }
};